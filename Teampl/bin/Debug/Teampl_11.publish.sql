...
GO
/*
[dbo].[postData].[certification] 열이 삭제되므로 데이터 손실이 발생할 수 있습니다.
*/
...
GO
ALTER TABLE [dbo].[postData] DROP CONSTRAINT [DF__tmp_ms_xx__certi__2F10007B];
...
GO
ALTER TABLE [dbo].[postData] DROP COLUMN [certification];
